...
export const RegisterFormReceiver = () => {
    ...
    return (
        ...
        <div>
            ...
            {errors.company?.message && <p className="input-waring">{errors.company.message}</p>}
        </div>

        <div>
            <Input label={"CNPJ"} id ={"cnpj"} type={"text"} register ={register("cnpj")} placeholder ={"Digite seu CNPJ aqui"}/>
            {errors.cnpj?.message && <p className="input-waring">{errors.cnpj.message}</p>}
        </div> 
        ...
        <div>
            ...
            {errors.sponsor?.message && <p className="input-waring">{errors.sponsor.message}</p>}
        </div>
